          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border border-white/60 overflow-hidden relative hover:shadow-3xl transition-shadow duration-300">
            ...
            <CardContent className="relative z-20 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 relative z-20">
                <Button
                  variant="outline"
                  className="w-full border-slate-300 hover:bg-slate-50 hover:border-slate-400 transition-all duration-200 py-3 bg-white text-slate-700 cursor-pointer h-12 font-medium hover:shadow-md"
                >
